...
name: aio-map
description: |
  Trace dependencies, call graphs, and blast radius for a file/function/module via GitNexus + LSP. Second step of the aio-deep-plan pipeline (after aio-discover, before aio-plan).
