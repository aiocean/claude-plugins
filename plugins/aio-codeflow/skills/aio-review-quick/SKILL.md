...
when_to_use: check my changes, before I commit, did I miss anything, review implementation, validate changes, post-implementation review, verify work, change validation, pre-commit check, quick review
effort: medium
context: fork
---
