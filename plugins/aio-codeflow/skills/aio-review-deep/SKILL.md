...
when_to_use: deep review, fleet review, multi-agent review, parallel review, ultra review, before merge, pre-merge gate, comprehensive review, multi-phase review, security + architecture review, GitNexus review
argument-hint: "PR ref, branch, or diff to review (optional — auto-detects current branch)"
effort: high
context: fork
...
| REQUEST CHANGES — needs fixes | Fix issues → re-run `/aio-review-deep` |
