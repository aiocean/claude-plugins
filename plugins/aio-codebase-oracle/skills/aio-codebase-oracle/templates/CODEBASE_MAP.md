...
analysis_method: CodeWiki static analysis + Oracle documentation
confidence: REPLACE_LEVEL
generated_docs:
  - CODEBASE_MAP.md
codewiki_static_analysis: REPLACE_YES_OR_NO
---

# Codebase Map

> Auto-generated by Codebase Oracle. Last mapped: REPLACE_TIMESTAMP
> Analysis method: CodeWiki static analysis + Oracle documentation
...
CodeWiki static analysis outputs:
...
```bash
# Check CodeWiki static analysis
...
**CodeWiki Static Analysis**: REPLACE_YES_OR_NO
...
| templates/ | CodeWiki doc structure templates |
| REPLACE | REPLACE: list Oracle-written module .md files |

## Static Analysis Metrics

<!-- ORACLE:METRICS
From CodeWiki codebase_map.json:
```bash
