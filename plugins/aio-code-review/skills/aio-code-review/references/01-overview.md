# Code Review Developer Guide — Overview
...
- **How To Do A Code Review** (`reviewer-*.md`): A detailed guide for code reviewers.
- **The CL Author's Guide** (`author-*.md`): A detailed guide for developers whose CLs are going through review.
...
See `reviewer-02-what-to-look-for.md` for more information.
