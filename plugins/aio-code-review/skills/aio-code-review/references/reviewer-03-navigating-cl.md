...
Now that you know [what to look for](reviewer-02-what-to-look-for.md), what's the most efficient way to manage a review that's spread across multiple files?

1. Does the change make sense? Does it have a good [description](author-01-cl-descriptions.md)?
