...
when_to_use: dashboard design, chart selection, dashboard review, KPI card, dataviz, chart a11y, dashboard anti-pattern, storytelling with data
argument-hint: "Dashboard URL, screenshot, or design brief"
effort: medium
---
