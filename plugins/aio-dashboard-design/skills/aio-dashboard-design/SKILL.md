...
description: |
  Design and review SaaS analytics dashboards — chart selection, anti-pattern detection, WCAG 2.2 accessibility, data-ink discipline, color palettes, and storytelling. Use as both design reference and review standard.
when_to_use: dashboard design, analytics dashboard, data visualization, dataviz, chart selection, chart review, KPI card, metric tile, dashboard review, accessible chart, a11y chart, dark mode chart, dashboard anti-pattern, chart anti-pattern, executive dashboard, operational dashboard, analytical dashboard, storytelling with data, color palette, dashboard typography, responsive dashboard
---
