---
title: "aio-mental-models"
description: "Decision and reasoning advisor — picks and applies mental models (first principles, inversion, second-order, opportunity cost, etc.) for trade-offs and complex problems."
document_type: "skill"
plugin: "aio-mental-models"
install: "/plugin install aio-mental-models@aiocean-plugins"
---

> From plugin [**aio-mental-models**](/vi/plugins/aio-mental-models) · `v2.1.5` · **Install:** `/plugin install aio-mental-models@aiocean-plugins`
