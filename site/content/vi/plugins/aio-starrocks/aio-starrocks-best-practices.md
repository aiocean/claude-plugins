---
title: "aio-starrocks-best-practices"
description: "StarRocks table design best practices — partitioning strategy, sort key selection, bucketing decisions, Primary Key table tuning, authentication/authorization, and resource group configuration."
document_type: "skill"
plugin: "aio-starrocks"
install: "/plugin install aio-starrocks@aiocean-plugins"
---

> From plugin [**aio-starrocks**](/vi/plugins/aio-starrocks) · `v1.0.2` · **Install:** `/plugin install aio-starrocks@aiocean-plugins`
