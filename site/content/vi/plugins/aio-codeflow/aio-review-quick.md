---
title: "aio-review-quick"
description: "Validate post-implementation changes against the aio-snapshot baseline — quick pre-commit sanity check via change detection, duplication detection, and type checking. For deep code review use aio-review-deep."
document_type: "skill"
plugin: "aio-codeflow"
...
| Needs full code review (security, architecture) | `/aio-review-deep` — multi-agent review with OMC agents |
