---
title: "aio-debug"
description: "Debug broken code — orchestrates codebase context gathering, root cause investigation, minimal fix, and code review validation via debugger agent."
document_type: "skill"
plugin: "aio-codeflow"
...
Phase 4: Verify & Review
    /superpowers:verification-before-completion → /aio-review-deep
```
...
2. Then invoke `/aio-review-deep` to launch parallel review agents
