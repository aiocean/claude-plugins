---
title: "aio-plan"
description: "Synthesize discovery and dependency mapping into a step-by-step implementation plan via planner agent. Step 3 of the codeflow discover → map → plan trio (after aio-discover and aio-map)."
document_type: "skill"
plugin: "aio-codeflow"
