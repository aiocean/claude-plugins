---
title: "aio-review"
description: "Validate post-implementation changes against the aio-snapshot baseline — quick pre-commit sanity check via change detection, duplication detection, and type checking. For deep code review use aio-code-review."
document_type: "skill"
plugin: "aio-planning"
install: "/plugin install aio-planning@aiocean-plugins"
---

> From plugin [**aio-planning**](/vi/plugins/aio-planning) · `v1.1.2` · **Install:** `/plugin install aio-planning@aiocean-plugins`
