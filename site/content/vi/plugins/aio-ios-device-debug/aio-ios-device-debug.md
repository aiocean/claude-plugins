...
description: "Debug iOS apps on physical devices — build, install, capture logs, extract crash reports, and take screenshots."
document_type: "skill"
plugin: "aio-ios-device-debug"
install: "/plugin install aio-ios-device-debug@aiocean-plugins"
---

> From plugin [**aio-ios-device-debug**](/vi/plugins/aio-ios-device-debug) · `v1.1.5` · **Install:** `/plugin install aio-ios-device-debug@aiocean-plugins`
