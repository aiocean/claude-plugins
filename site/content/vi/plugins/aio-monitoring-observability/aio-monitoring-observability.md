...
description: "Design metrics, alerts, dashboards, and SLOs using monitoring best practices (Four Golden Signals, RED/USE method)."
document_type: "skill"
plugin: "aio-monitoring-observability"
install: "/plugin install aio-monitoring-observability@aiocean-plugins"
---

> From plugin [**aio-monitoring-observability**](/vi/plugins/aio-monitoring-observability) · `v1.0.8` · **Install:** `/plugin install aio-monitoring-observability@aiocean-plugins`
