---
title: "aio-research-kit"
description: "Run structured 10-phase research workflows via research-cli (auto-installs if missing)."
document_type: "skill"
plugin: "aio-research"
install: "/plugin install aio-research@aiocean-plugins"
---

> From plugin [**aio-research**](/vi/plugins/aio-research) · `v1.0.2` · **Install:** `/plugin install aio-research@aiocean-plugins`
