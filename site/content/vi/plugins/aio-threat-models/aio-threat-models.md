...
description: "Threat modeling framework advisor — selects, applies, and composes frameworks (STRIDE, LINDDUN, PASTA, MITRE ATT&CK/ATLAS, Attack Trees, etc.) for security, privacy, AI/ML, cloud, and Kubernetes risk analysis."
document_type: "skill"
plugin: "aio-threat-models"
install: "/plugin install aio-threat-models@aiocean-plugins"
---

> From plugin [**aio-threat-models**](/vi/plugins/aio-threat-models) · `v1.0.2` · **Install:** `/plugin install aio-threat-models@aiocean-plugins`
