---
title: "aio-browser-cookie"
description: "Extract cookies from local browsers (Chrome/Firefox/Safari) and export them as JSON or Netscape format for authenticated requests."
document_type: "skill"
plugin: "aio-browser-cookie"
install: "/plugin install aio-browser-cookie@aiocean-plugins"
---

> From plugin [**aio-browser-cookie**](/vi/plugins/aio-browser-cookie) · `v2.0.5` · **Install:** `/plugin install aio-browser-cookie@aiocean-plugins`
