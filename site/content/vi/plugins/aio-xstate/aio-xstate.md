---
title: "aio-xstate"
description: "Implement XState v5 state machines with strict patterns — setup().createMachine(), actors, and TypeScript typing."
document_type: "skill"
plugin: "aio-xstate"
install: "/plugin install aio-xstate@aiocean-plugins"
---

> From plugin [**aio-xstate**](/vi/plugins/aio-xstate) · `v1.0.8` · **Install:** `/plugin install aio-xstate@aiocean-plugins`
