...
document_type: "skill"
plugin: "aio-visual-diff"
install: "/plugin install aio-visual-diff@aiocean-plugins"
---

> From plugin [**aio-visual-diff**](/vi/plugins/aio-visual-diff) · `v0.1.0` · **Install:** `/plugin install aio-visual-diff@aiocean-plugins`
