---
title: "aio-tui"
description: "Build interactive terminal UIs with Go Bubbletea and lipgloss — architecture, styling, and patterns."
document_type: "skill"
plugin: "aio-tui"
install: "/plugin install aio-tui@aiocean-plugins"
---

> From plugin [**aio-tui**](/vi/plugins/aio-tui) · `v1.0.7` · **Install:** `/plugin install aio-tui@aiocean-plugins`
