---
title: "aio-grafana-diagram"
description: "Create Grafana diagrams for system visualization — analyzes codebase to auto-generate Mermaid diagrams with metric binding. For standalone Mermaid diagrams use aio-mermaid instead."
document_type: "skill"
plugin: "aio-diagramming"
install: "/plugin install aio-diagramming@aiocean-plugins"
---

> From plugin [**aio-diagramming**](/vi/plugins/aio-diagramming) · `v1.0.2` · **Install:** `/plugin install aio-diagramming@aiocean-plugins`
