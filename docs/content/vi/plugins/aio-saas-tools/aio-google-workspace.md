---
title: "aio-google-workspace"
description: "Interact with Google Workspace services (Gmail, Drive, Calendar, Sheets, Docs, Tasks) via the gws CLI."
document_type: "skill"
plugin: "aio-saas-tools"
install: "/plugin install aio-saas-tools@aiocean-plugins"
---

> From plugin [**aio-saas-tools**](/vi/plugins/aio-saas-tools) · `v1.0.2` · **Install:** `/plugin install aio-saas-tools@aiocean-plugins`
