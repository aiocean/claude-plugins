---
title: "aio-kanban"
description: "Markdown-based kanban board for AI agent task management — init, add, move, archive tasks across backlog/doing/done columns."
document_type: "skill"
plugin: "aio-kanban"
install: "/plugin install aio-kanban@aiocean-plugins"
---

> From plugin [**aio-kanban**](/vi/plugins/aio-kanban) · `v2.0.2` · **Install:** `/plugin install aio-kanban@aiocean-plugins`
