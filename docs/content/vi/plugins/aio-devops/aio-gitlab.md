---
title: "aio-gitlab"
description: "Manage GitLab MRs, pipelines, branches, and CI jobs via gitlab-mcp (auto-installs if missing)."
document_type: "skill"
plugin: "aio-devops"
install: "/plugin install aio-devops@aiocean-plugins"
---

> From plugin [**aio-devops**](/vi/plugins/aio-devops) · `v1.0.2` · **Install:** `/plugin install aio-devops@aiocean-plugins`
