---
title: "aio-bun-fullstack-setup"
description: "Scaffold a Bun fullstack project — single-port server, Vite dev proxy, monorepo layout, and Docker config."
document_type: "skill"
plugin: "aio-bun-fullstack-setup"
install: "/plugin install aio-bun-fullstack-setup@aiocean-plugins"
---

> From plugin [**aio-bun-fullstack-setup**](/vi/plugins/aio-bun-fullstack-setup) · `v1.1.3` · **Install:** `/plugin install aio-bun-fullstack-setup@aiocean-plugins`
