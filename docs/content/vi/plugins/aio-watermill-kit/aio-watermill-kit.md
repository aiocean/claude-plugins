---
title: "aio-watermill-kit"
description: "Build event-driven Go apps with Watermill — Router, middleware chains, Pub/Sub patterns, CQRS, and broker integrations (Kafka, AMQP, NATS, Redis Streams, SQL)."
document_type: "skill"
plugin: "aio-watermill-kit"
install: "/plugin install aio-watermill-kit@aiocean-plugins"
---

> From plugin [**aio-watermill-kit**](/vi/plugins/aio-watermill-kit) · `v0.1.2` · **Install:** `/plugin install aio-watermill-kit@aiocean-plugins`
