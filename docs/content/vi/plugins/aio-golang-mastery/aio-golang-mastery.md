...
description: "Write, review, and lint Go code. Lint mode runs go build, go vet, golangci-lint, govulncheck, nilaway, deadcode, and race detection, then applies idiomatic fixes. Reference mode covers concurrency, error handling, generics, testing, gRPC, and production hardening."
document_type: "skill"
plugin: "aio-golang-mastery"
install: "/plugin install aio-golang-mastery@aiocean-plugins"
---

> From plugin [**aio-golang-mastery**](/vi/plugins/aio-golang-mastery) · `v1.1.3` · **Install:** `/plugin install aio-golang-mastery@aiocean-plugins`
